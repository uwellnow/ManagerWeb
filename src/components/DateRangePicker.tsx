...
const DateRangePicker = ({ isOpen, onClose, onDateRangeSelect, currentRange }: DateRangePickerProps) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 w-full max-w-sm sm:max-w-md">
                <div className="flex justify-between items-center mb-4 sm:mb-6">
                    <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">기간 선택</h3>
                    <button
                        onClick={onClose}
