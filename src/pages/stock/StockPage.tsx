...
const StockPage = () => {
    ...
    return (
        <div className="flex-1 p-6 ">
            ...
            {/* 재고 요약 */}
            <div className="mb-4">
                <h2 className="text-lg font-semibold text-gray-900">재고 ({filteredStocks.length})</h2>
            </div>
                    ...
                    <table className="min-w-full">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">마지막 충전 시간</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">담당자</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">재고 현황</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">재고 상태</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">충전 여부</th>
                            </tr>
                        </thead>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 w-96 max-w-md">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-lg font-semibold text-gray-900">재고 보충</h3>
                            <button
